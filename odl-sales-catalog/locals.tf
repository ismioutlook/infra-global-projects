locals {
  ...
  kv_admin_object_ids = ["75f9a0c1-6e61-4cbe-beba-9ab39034b9a0", local.current_user_id, "212ab792-786b-40d4-9cae-3e21087453f2", azurerm_linux_function_app.sales-catalog-ingestion-fap.identity[0].principal_id]
