module "eu_gl_appgw" {
  source                  = "git@ssh.dev.azure.com:v3/ELX-Marketing-DevOps/infra-modules/infra-mod-AppGw//module?ref=v0.0.15.4"
  ...
  grafana_hostname              = var.eu_vars.app_gateway.grafana_hostname
  origin_grafana_hostname       = var.eu_vars.app_gateway.origin_grafana_hostname
