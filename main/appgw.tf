...
module "us2_gl_appgw" {
  ...
  appgw_pip_name          = var.us2_vars.app_gateway.appgw_pip_name
  appgw_pip_allocation    = var.us2_vars.app_gateway.appgw_pip_allocation
  appgw_name              = var.us2_vars.app_gateway.appgw_name
  appgw_sku_name          = var.us2_vars.app_gateway.appgw_sku_name
