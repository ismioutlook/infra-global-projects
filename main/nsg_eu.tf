resource "azurerm_network_security_group" "nsg_apim" {
  ...
  security_rule {
    name                       = "Management_endpoint_for_API"
    priority                   = 120
    direction                  = "Inbound"
    access                     = "Allow"
    protocol                   = "Tcp"
  ...
  security_rule {
    name                       = "AllowInboundRangeForTrafficManager"
    priority                   = 350
    direction                  = "Inbound"
    access                     = "Allow"
    protocol                   = "Any"
  ...
  security_rule {
    name                       = "AllowAPIMToTrafficManager"
    priority                   = 360
    direction                  = "Inbound"
    access                     = "Allow"
    protocol                   = "Tcp"
  ...
  security_rule {
    name                       = "Dependency_for_Log_to_event_hub"
    priority                   = 150
    direction                  = "Outbound"
    access                     = "Allow"
    protocol                   = "Any"
  ...
  security_rule {
    name                       = "Dependency_on_Azure_File_Storage"
    priority                   = 170
    direction                  = "Outbound"
    access                     = "Allow"
    protocol                   = "TCP"
  ...
  security_rule {
    ...
    protocol                   = "Tcp"
    source_port_range          = "*"
    destination_port_range     = "1886,443,12000"
    source_address_prefix      = "VirtualNetwork"
