# resource "azurerm_network_security_group" "nsg_apac_apim" {
#   location            = var.apac_vars.resource_group.resource_group_location
#   resource_group_name = var.apac_vars.resource_group.resource_group_name
#   name                = "nsg-apac-apim-gl-nonprod"
...
# resource "azurerm_network_security_group" "nsg_apac_apim_mgmt" {
#   location            = var.apac_vars.resource_group.resource_group_location
#   resource_group_name = var.apac_vars.resource_group.resource_group_name
#   name                = "nsg-apac-mgmt-gl-nonprod"
#   security_rule {
#     access                     = "Allow"
...
# resource "azurerm_network_security_group" "nsg_apac_apim_gw" {
#   location            = var.apac_vars.resource_group.resource_group_location
#   resource_group_name = var.apac_vars.resource_group.resource_group_name
#   name                = "nsg-apac-gw-gl-nonprod"
#   security_rule {
#     access                     = "Allow"
#     destination_address_prefix = "*"
#     destination_port_range     = "443"
